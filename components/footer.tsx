        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Image
                ...
                className="rounded"
              />
              <span className="text-xl font-bold text-foreground">CS Nostalgia</span>
            </div>
            <p className="text-sm text-muted-foreground">
              A comunidade brasileira de Counter-Strike 1.6 que une jogadores de todo o país desde 2024.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#servidores" className="text-muted-foreground hover:text-foreground transition-colors">
                  Nossos Servidores
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#loja" className="text-muted-foreground hover:text-foreground transition-colors">
                  Loja de Cargos
                </a>
              </li>
            </ul>
